/* Template counting sort class that provides special methods
 * to sort a templated data structure (array, vector)
 * by utilizing counting sort algorithm and print sorted data structure
 * Time complexity: O(a + b) where a = size of the data structure
 * and b = size of count data structure.
 */
...
//Class declaration for CountingSort
template <typename T>
class CountingSort {
    ...
    public:
        ...
        CountingSort(T& data, size_t size) : data_(data), size_(size) {}

        //Method to determine whether data type is compatible (array) with the method countingSortArrAndVecImp
        void countingSortArr() {
            ...
            countingSortArrAndVecImp();
        }

        //Method to determine whether data type is compatible (vector) with the method countingSortArrAndVecImp
        void countingSortVec() {
